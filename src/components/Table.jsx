...
<table className="min-w-full divide-y divide-gray-200">
  <thead>
    <tr className="text-left text-base sm:text-lg border-b border-gray-300">
      <th className="py-2 sm:py-3 font-light min-w-[120px] xl:pr-24">Application ID</th>
      <th className="py-2 sm:py-3 font-light min-w-[160px] xl:pr-24">Date</th>
      <th className="py-2 sm:py-3 font-light min-w-[120px] xl:pr-40">Status</th>
      <th className="py-2 sm:py-3 font-light min-w-[40px] text-center xl:pr-6">Status</th>
    </tr>
  </thead>
  <tbody>
    {filtered.map((app, idx) => (
      ...
      >
        <td className="text-blue-600 py-3 sm:py-4 xl:pr-24">{app.id}</td>
        <td className="py-3 sm:py-4 text-gray-600 xl:pr-24">{app.date}</td>
